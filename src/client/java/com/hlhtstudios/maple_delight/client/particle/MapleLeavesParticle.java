package com.hlhtstudios.maple_delight.client.particle;
...
public class MapleLeavesParticle extends SpriteBillboardParticle {
    ...
    public MapleLeavesParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
