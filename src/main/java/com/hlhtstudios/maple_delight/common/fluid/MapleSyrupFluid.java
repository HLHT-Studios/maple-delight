...
public class MapleSyrupFluid extends FlowableFluid {
    @Override
    ...
    public Fluid getStill() {
        return MapleFluid.MAPLE_SAP_STILL;
    }

    @Override
    public Fluid getFlowing() {
        return MapleFluid.MAPLE_SAP_FLOWING;
    }

    @Override
    public Item getBucketItem() {
        return MapleItems.MAPLE_SAP_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return MapleFluidBlock.MAPLE_SAP_FLUID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
