...
public class ConfigedFeatures {
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, MAPLE_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                BlockStateProvider.of(Maples.MAPLE_LOG),
                new StraightTrunkPlacer(5, 1, 1),
                BlockStateProvider.of(Maples.MAPLE_LEAVES),
                new PineFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(1), ConstantIntProvider.create(6)),


                new TwoLayersFeatureSize(1, 0, 2)).build());

        register(context, RED_MAPLE_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                BlockStateProvider.of(Maples.RED_MAPLE_LOG),
                new StraightTrunkPlacer(6, 2, 1),
                BlockStateProvider.of(Maples.RED_MAPLE_LEAVES),
                new PineFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(1), ConstantIntProvider.create(6)),
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, new Identifier(Maple_delight.MOD_ID, name));
    }
